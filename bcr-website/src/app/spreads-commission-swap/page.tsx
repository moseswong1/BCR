...
export default function SpreadsCommissionSwapPage() {
  ...
  return (
    <div className="bg-white">
      {/* Gold hero band (Account Overview vibe) */}
      <section className="border-b border-gray-200 bg-gradient-to-r from-amber-800 via-amber-600 to-amber-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          ...
          <p className="mt-3 max-w-3xl text-lg text-white/80">
            Start trading with BCR, enjoy spreads from 0.0 pips* and low commission!
          </p>
          <div className="mt-6 h-[2px] w-24 bg-white/70" />
        </div>
      </section>

      {/* Sub-nav pills (matches the Trading Conditions strip) */}
      <section className="border-b border-t border-[#EFEFF0] bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex gap-6 overflow-x-auto py-4 text-xs sm:text-sm font-semibold uppercase tracking-widest">
            <Link href="/spreads-commission-swap" className="whitespace-nowrap text-[#FFB800]">
              Spreads, Commission &amp; Swap
            </Link>
            <Link href="/margin-leverage" className="whitespace-nowrap text-gray-500 hover:text-[#FFB800]">
              Margin &amp; Leverage
            </Link>
            <Link href="/trading-hours" className="whitespace-nowrap text-gray-500 hover:text-[#FFB800]">
              Trading Hours
            </Link>
          </div>
        </div>
      ...
      {/* Premium Clients style inner panel */}
