...
import { Monitor, Smartphone, Globe, ChevronRight, Check, Zap, Headphones, Award, TrendingUp, BarChart3 } from "lucide-react";
...
export default function MT5Page() {
  ...
  const bcrAdvantages = [
    ...
    { icon: Award, title: "Award-winning broker", description: "Trade with confidence knowing BCR is a multi-award winning regulated broker." }
  ];
